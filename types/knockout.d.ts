...
type KnockoutBindingHandlerInitMethod = (element: any, valueAccessor: () => any, allBindingsAccessor: KnockoutAllBindingsAccessor, viewModel: any, bindingContext: KnockoutBindingContext) => void | { controlsDescendantBindings: boolean; };
type KnockoutBindingHandlerUpdateMethod = (element: any, valueAccessor: () => any, allBindingsAccessor: KnockoutAllBindingsAccessor, viewModel: any, bindingContext: KnockoutBindingContext) => void;

interface KnockoutBindingHandler {
    after?: Array<string>;
    init?: KnockoutBindingHandlerInitMethod;
    update?: KnockoutBindingHandlerUpdateMethod;
    options?: any;
...
interface KnockoutUtils {
    ...
    cloneNodes: (nodes: Node[], shouldCleanNodes: boolean) => Node[];
...
interface KnockoutStatic {
    ...
    isWritableObservable(instance: any): instance is KnockoutObservable<any>;
