(function (factory) {
    if (typeof define === "function" && define.amd) { // AMD.
        define(["jquery", "knockout", "./ui.tooltip", "../../../Bindings/koJquiBindingFactory", "./tooltipConditions"], factory);
    } else { // Global
        factory(jQuery, ko);
    }
}(function ($, ko) {
    ...
    ko.bindingHandlers.tooltip = new DWTS.BindingHandlers.LazyBinding.LazyBindingHandler(
        'tooltipsettings',
        'mouseover focus',
        ...
        DWTS.BindingHandlers.LazyBinding.prepareAttachDebounced);
