...
declare module DW {
    ...
    export class Command extends DWTS.Disposable {
...
declare module DW.Commands {

    export class Bundle extends DWTS.Disposable {
        ...
        /**
          ...
          * @return {void}
          */
        public setCommands(commands: DW.Command[]): void;
