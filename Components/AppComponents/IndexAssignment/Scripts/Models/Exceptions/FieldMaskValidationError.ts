...
namespace DW.IndexAssignment.Models.Exceptions {
    ...
    export class FieldMaskValidationError implements IValidationError {
        public field: IField;
        ...
        constructor(field: IField, errorMessage: string = '') {
            ...
            if (errorMessage) {
                ...
                this.errorMessage = DW.IndexAssignment.localize('IndexAssignment_ValidationError_FieldMask');
            }
        }
    }
}